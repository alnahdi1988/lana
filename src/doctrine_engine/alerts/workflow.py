...
class AlertWorkflow:
    ...
    def evaluate(self, workflow_input: AlertWorkflowInput) -> AlertDecisionResult:
        ...
        payload = AlertDecisionPayload(
            ...
            setup_state=signal_result.setup_state,
            market_regime=signal_result.extensible_context.get("market_regime"),
            sector_regime=signal_result.extensible_context.get("sector_regime"),
            event_risk_class=signal_result.extensible_context.get("event_risk_class"),
            entry_type=trade_plan_result.entry_type,
